...
(function () {
  ...
  window.VersoEditor.provideLive({
    // arch-P3b-07h: set only for the duration of a source-link placement, and read by the insert
    // path to land each block where the author dropped it rather than at the selection.
    __sourceLinkDropAt: function () { return __sourceLinkDropAt; },
